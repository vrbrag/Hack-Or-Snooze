...
class StoryList {
  ...
  static async getStories() {
    ...
    //  instance method? 
    // -->> It only needs to be called when the user requests it, rather than it running automatically when the page loads.
...
class User {
  ...
  async removeFavoriteStory(story) {
    // if storyId !== story.storyId then filter out
    this.favorites = this.favorites.filter(arr => arr.storyId !== story.storyId)
